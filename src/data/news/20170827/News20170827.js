...
export default class News20170827 extends React.Component {
  ...
  render() {
    ...
    const content = {
      ...
      dateSubtitle: {
        en: {
          __html: `Lighting a palace in Beirut`
        },
        fr: {
          __html: `Mise en lumière d’un palais à Beyrouth`
        }
      },
      // description: {
      ...
      <div className="news__20170827--content news__content main__content">
        ...
        <div className="news__20170827--column3--container column3--container active">
          <div className="news__20170827--column3">
            <div className="news__20170827--date">{content.date[this.props.language]()}</div>
            <div className="news__20170827--date--datesubtitle" dangerouslySetInnerHTML={content.dateSubtitle[this.props.language]}></div>
