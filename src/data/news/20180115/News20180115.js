  ...
  render() {
    ...
    const content = {
      ...
      newsDescription: {
        ...
        fr: 'Nous avons le plaisir d’accueillir Mathilde Lizoret au sein de l’agence. Elle sera notamment responsable du montage du dossier de permis de construire du complexe scolaire.'
      },
      blague: {
        en: 'What a joke !',
