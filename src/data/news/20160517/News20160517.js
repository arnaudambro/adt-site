      ...
      <div className="news__20160517--content news__content main__content">
        ...
        <div className="news__20160517--column3--container column3--container active">
          <div className="news__20160517--column3">
            <div className="news__20160517--date">{content.date[this.props.language]()}</div>
            <div className="news__20160517--date--datesubtitle" dangerouslySetInnerHTML={content.dateSubtitle[this.props.language]}></div>
