...
import pic from './atelier-delalande-tabourin-news-scierie-eb12.png';
...
export default class News20161214 extends React.Component {
  render() {
    const content = {
      ...
      dateSubtitle: {
        en: {
          __html: `Visit of the sawmill of Vitry-aux-Loges for the project of Barillet company.`
        },
        fr: {
          __html: `Visite de la scierie de Vitry-aux-Loges pour le projet de l'entreprise Barillet.`
        }
      }
      // description: {
