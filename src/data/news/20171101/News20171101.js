      ...
      <div className="news__20171101--content news__content main__content">
        ...
        <div className="news__20171101--column3--container column3--container active">
          <div className="news__20171101--column3">
            <div className="news__20171101--date">{content.date[this.props.language]()}</div>
            <div className="news__20171101--date--datesubtitle" dangerouslySetInnerHTML={content.dateSubtitle[this.props.language]}></div>
