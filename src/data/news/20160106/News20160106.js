...
import pic from './atelierdelalandetabourinnewspressearmor.png';
      ...
      <div className="news__20160106--content news__content main__content">
        ...
        <div className="news__20160106--column3--container column3--container active">
          <div className="news__20160106--column3">
            <div className="news__20160106--date">{content.date[this.props.language]()}</div>
            <div className="news__20160106--date--datesubtitle" dangerouslySetInnerHTML={content.dateSubtitle[this.props.language]}></div>
