...
import pic from './atelierdelalandetabourinnewsmaquetteetudehd11.jpg';
      ...
      <div className="news__20170410--content news__content main__content">
        ...
        <div className="news__20170410--column3--container column3--container active">
          <div className="news__20170410--column3">
            <div className="news__20170410--date">{content.date[this.props.language]()}</div>
            <div className="news__20170410--date--datesubtitle" dangerouslySetInnerHTML={content.dateSubtitle[this.props.language]}></div>
