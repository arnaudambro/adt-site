...
import pic from './atelierdelalandetabourinnewscourrierarchi.png';
      ...
      <div className="news__20150909--content news__content main__content">
        ...
        <div className="news__20150909--column3--container column3--container active">
          <div className="news__20150909--column3">
            <div className="news__20150909--date">{content.date[this.props.language]()}</div>
            <div className="news__20150909--date--datesubtitle" dangerouslySetInnerHTML={content.dateSubtitle[this.props.language]}></div>
