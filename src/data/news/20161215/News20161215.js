      ...
      <div className="news__20161215--content news__content main__content">
        ...
        <div className="news__20161215--column3--container column3--container active">
          <div className="news__20161215--column3">
            <div className="news__20161215--date">{content.date[this.props.language]()}</div>
            <div className="news__20161215--date--datesubtitle" dangerouslySetInnerHTML={content.dateSubtitle[this.props.language]}></div>
