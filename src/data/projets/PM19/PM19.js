  ...
  render() {
    ...
    return(
      ...
      <div className="projet projet__PM19 main__content projet__content">
        ...
        <p>Située près du château de Brézé, la parcelle accueille une maison articulée autour de plusieurs cours et d’un vaste jardin filant à deux mètres au-dessus du niveau  la maison. Le projet vient s’y insérer et créer une pente légère liant maison et jardin. La pierre calcaire, présente dans la région et habillant les façades alentour devient l’élément principal.</p>
        <p>Seuls trois matériaux sont utilisés : la pierre de tuffeau, le béton brut et l’eau.</p>
        <p>Murs de pierre et mobilier béton viennent créer les espaces extérieurs autour du plan d’eau. On glisse derrière un mur pour se changer, derrière un autre pour plonger. Ce jeu de stèles cadre les vues d’un paysage à l’autre. On s’y promène comme dans une ruine.</p>
