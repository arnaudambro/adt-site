  ...
  render() {
    ...
    return(
      ...
      <div className="projet projet__VB229 main__content projet__content">
        ...
        <p>Le projet consiste ici à surélever et réhabiliter trois corps de ferme mitoyens au sein d’une propriété en Sologne.</p>
        <p>Présent sur les bâtiments existants, comme dans toute la région, l’usage de la brique est devenu une évidence, d’autant que la dernière briqueterie artisanale de France se trouve à 15km du site.</p>
        <p>Un jeu traditionnel de briques viendra donc établir en façade un dialogue contemporain entre l’existant et le projet. Une composition avec deux rythmes d’enchevêtrement de blocs d’argile différenciera subtilement la surélévation du reste des bâtiments. Comme un hommage à une architecture passée.</p>
        <p>A l’intérieur, de nombreux puits de lumière viendront illuminer l‘espace et révéler la délicate association de la brique, du bois et du béton ciré.</p>
