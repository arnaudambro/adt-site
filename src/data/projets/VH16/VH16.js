  ...
  render() {
    ...
    return (
      <div className="projet projet__VH16 main__content projet__content">
        ...
        <p>
          D’origine syrienne, le client nous a dès le début de l’esquisse montré
          son envie de retrouver dans son projet VH16 une approche contemporaine
          de son architecture natale.
        </p>
        <p>
          La maison est donc constituée d’un volume sobre de plein-pied. Avec
          une organisation basée sur un plan carré évidé en son centre par un
          patio végétalisé. Ce principe permet à l’habitation de concentrer ses
          espaces de vie autour d’un jardin central calme et isolé. Toute en y
          optimisant l’apport de lumière.
        </p>
        <p>
          Ainsi une fois toutes les baies vitrées du patio intérieur ouvertes.
          tous les différents espaces de la maison se transforment en un seul
          espace libre au milieu de la végétation.
        </p>
        <p>
          A l’extérieur, l’usage d’un enduit balayé ton pierre vient donner un
          côté naturel à la façade. Mais il permet aussi à l’agence de
          revaloriser l’image d’un matériau stérile et ennuyeux.
        </p>
