...
import matiere from './be69_material.png';
import concept from './img/atelierdelalandetabourin-bureau-loiret-orleans-black-BE69-concept.jpg';
import accueil from './img/atelierdelalandetabourin-bureau-loiret-orleans-black-BE69-accueil.jpg';
import bureau from './img/atelierdelalandetabourin-bureau-loiret-orleans-black-BE69-bureau.jpg';
import axonometrie_r1 from './img/atelierdelalandetabourin-bureau-loiret-orleans-black-BE69-axonometrie r+1.jpg';
import axonometrie_r3 from './img/atelierdelalandetabourin-bureau-loiret-orleans-black-BE69-axonometrie r+3.jpg';
import axonometrie_rdc from './img/atelierdelalandetabourin-bureau-loiret-orleans-black-BE69-axonometrie rdc.jpg';
import facade from './img/atelierdelalandetabourin-bureau-loiret-orleans-black-BE69-facade.jpg';
import texture_plan_r1 from './img/atelierdelalandetabourin-bureau-loiret-orleans-black-BE69-texture-plan r+1.jpg';
import texture_plan_r3 from './img/atelierdelalandetabourin-bureau-loiret-orleans-black-BE69-texture-plan r+3.jpg';
import texture_plan_rdc from './img/atelierdelalandetabourin-bureau-loiret-orleans-black-BE69-texture-plan rdc.jpg';
    ...
    return (
      <div className="projet projet__BE69 main__content projet__content">
        ...
        <div className="projet__image--fullWidth">
          <img src={matiere} alt="plan" />
        </div>
        <div className="projet__divider projet__divider--thick" />
        <p>
          Situé en plein cœur d’Orléans, l’immeuble classé du 69 boulevard
          Alexandre Martin accueille désormais le siège de la société EALIS.
          Nous sommes donc partis de l’identité graphique de cette entreprise
          afin de pouvoir imaginer et concevoir le projet de réhabilitation de
          leurs futurs bureaux.
        </p>
        <p>
