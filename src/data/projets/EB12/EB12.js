  ...
  render() {
    ...
    return (
      <div className="projet projet__EB12 main__content projet__content">
        ...
        <p>
          Spécialisée dans l’exploitation forestière et la scierie, la société
          est historiquement située au cœur de la forêt d’Orléans. La demande du
          client est d’étendre et de réhabiliter les 600m2 de locaux de son
          siège social. La proximité de la matière première, et de son usinage,
          s’est naturellement imposée comme le point de départ de notre
          réflexion et de la conception architecturale du projet.
        </p>
        <p>
          Le bâtiment s’organise aujourd’hui sous la forme d’un « U » autour
          d’un patio végétalisé. L’extension viendra aligner et refermer en
          partie le volume initial tandis qu’un couloir de verre traversera le
          patio pour faciliter les déplacements transitoires entre les ailes
          nord et sud. Ensuite, un long couloir intérieur dessert les différents
          espaces de l’entreprise.
        </p>
        <p>
          Notre intention première est d’apporter de la lumière et de la
          profondeur. Mais également une homogénéité esthétique entre cette
          longue déambulation circulaire et les espaces de travail desservis.
          Grâce à un jeu de claires-voies extérieures, la nouvelle façade écran
          apportera une continuité entre l’extension et l’existant. Une
          dynamique de tasseaux de bois thermo-chauffés, sous forme de grandes
          portes pivotantes, viendra animer la façade, tout en cachant le
          système de climatisation existant.
        </p>
        <p>
