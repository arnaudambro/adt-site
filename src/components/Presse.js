...
export default class Presse extends React.Component {
  ...
  render() {
    ...
    return(
      ...
      <div className="presse__container main__container" ref={(contentArea) => { this.contentArea = contentArea }}>
        <Helmet>
          <title>ATD | Presse</title>
        </Helmet>
        {Object
          .keys(data_presse)
        ...
        <div className="main__container--marginbottom presse" onClick={this.handleClick}></div>
      </div>
      )
  }
}
