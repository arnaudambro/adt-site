...
export default class Database extends React.Component {
  ...
  componentWillUnmount() {
    this.props.orderingParameters(this.state);
  }
  ...
  render() {
    ...
    const arrayToShowInDatabase = Object.keys(data_projets).sort((a, b) => {
      if (data_projets[a][`${this.state.sortBy}`]) {
        ...
        if (
          data_projets[a][`${lang}`][`${this.state.sortBy}`] >
          data_projets[b][`${lang}`][`${this.state.sortBy}`]
        ) {
          return this.state.ascendant ? 1 : -1;
        } else {
          return this.state.ascendant ? -1 : 1;
    ...
    return (
      <div
        className="main__container ts_projets table"
        ref={contentArea => {
        ...
        <div className="main__content database">
              ...
              <div className={`th th__container name`}>
                <div className="th__container--content ">
                  <img
                    ...
                    id="arrow1"
                    src={
                      this.state.currentArrow === 'arrow1'
                        ? content.arrow.down_active
                        : content.arrow.down_inactive
                    }
                    alt=""
                  ...
                  <img
                    ...
                    id="arrow2"
                    src={
                      this.state.currentArrow === 'arrow2'
                        ? content.arrow.up_active
                        : content.arrow.up_inactive
                    }
                    alt=""
              ...
              <div className={`th th__container winyear`}>
                <div className="th__container--content ">
                  <img
                    ...
                    id="arrow3"
                    src={
                      this.state.currentArrow === 'arrow3'
                        ? content.arrow.down_active
                        : content.arrow.down_inactive
                    }
                    alt=""
                  ...
                  <img
                    ...
                    id="arrow4"
                    src={
                      this.state.currentArrow === 'arrow4'
                        ? content.arrow.up_active
                        : content.arrow.up_inactive
                    }
                    alt=""
              ...
              <div className={`th th__container madefor`}>
                <div className="th__container--content ">
                  <img
                    ...
                    id="arrow5"
                    src={
                      this.state.currentArrow === 'arrow5'
                        ? content.arrow.down_active
                        : content.arrow.down_inactive
                    }
                    alt=""
                  ...
                  <img
                    ...
                    id="arrow6"
                    src={
                      this.state.currentArrow === 'arrow6'
                        ? content.arrow.up_active
                        : content.arrow.up_inactive
                    }
                    alt=""
              ...
              <div className={`th th__container location`}>
                <div className="th__container--content ">
                  <img
                    ...
                    id="arrow7"
                    src={
                      this.state.currentArrow === 'arrow7'
                        ? content.arrow.down_active
                        : content.arrow.down_inactive
                    }
                    alt=""
                  ...
                  <img
                    ...
                    id="arrow8"
                    src={
                      this.state.currentArrow === 'arrow8'
                        ? content.arrow.up_active
                        : content.arrow.up_inactive
                    }
                    alt=""
              ...
              <div className={`th th__container function`}>
                <div className="th__container--content ">
                  <img
                    ...
                    id="arrow9"
                    src={
                      this.state.currentArrow === 'arrow9'
                        ? content.arrow.down_active
                        : content.arrow.down_inactive
                    }
                    alt=""
                  ...
                  <img
                    ...
                    id="arrow10"
                    src={
                      this.state.currentArrow === 'arrow10'
                        ? content.arrow.up_active
                        : content.arrow.up_inactive
                    }
                    alt=""
              ...
              <div className={`th th__container floorarea`}>
                <div className="th__container--content ">
                  <img
                    ...
                    id="arrow11"
                    src={
                      this.state.currentArrow === 'arrow11'
                        ? content.arrow.down_active
                        : content.arrow.down_inactive
                    }
                    alt=""
                  ...
                  <img
                    ...
                    id="arrow12"
                    src={
                      this.state.currentArrow === 'arrow12'
                        ? content.arrow.up_active
                        : content.arrow.up_inactive
                    }
                    alt=""
              ...
              <div className={`th th__container status`}>
                <div className="th__container--content ">
                  <img
                    ...
                    id="arrow13"
                    src={
                      this.state.currentArrow === 'arrow13'
                        ? content.arrow.down_active
                        : content.arrow.down_inactive
                    }
                    alt=""
                  ...
                  <img
                    ...
                    id="arrow14"
                    src={
                      this.state.currentArrow === 'arrow14'
                        ? content.arrow.up_active
                        : content.arrow.up_inactive
                    }
                    alt=""
              ...
              <div className={`th th__container material`}>
                <div className="th__container--content ">
                  <img
                    ...
                    id="arrow15"
                    src={
                      this.state.currentArrow === 'arrow15'
                        ? content.arrow.down_active
                        : content.arrow.down_inactive
                    }
                    alt=""
                  ...
                  <img
                    ...
                    id="arrow16"
                    src={
                      this.state.currentArrow === 'arrow16'
                        ? content.arrow.up_active
                        : content.arrow.up_inactive
                    }
                    alt=""
          ...
          <div className="tr tr__empty">
            <div className="tr__contour">
              ...
              <div className="td winyear" />
              <div className="td madefor" />
              <div className="td location" />
              <div className="td function" />
              <div className="td floorarea" />
              <div className="td phase" />
              <div className="td material" />
            </div>
          </div>
        </div>
        <div
