...
get_pw () {
  sudo security 2>&1 >/dev/null find-internet-password -s "ftp.cluster020.hosting.ovh.net" -a "atelierdhn" -w \
  | sed 's/password: "\(.*\)"/\1/'
}
...
echo -e "\n\n\033[1;33mTransfer completed 😬 https://www.atelierdelalandetabourin.com\n \n\033[0;39m"
